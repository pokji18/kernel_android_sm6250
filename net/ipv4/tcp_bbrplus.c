 ...
 * making it well-suited for high-throughput and low-latency network
 * scenarios including mobile gaming workloads.
 *
 ...
 *
 * Adapted back to the 4.14 kernel by trimming the mainline ack-aggregation
 * (extra_acked) state so struct bbr fits ICSK_CA_PRIV_SIZE (88 bytes).
 */
...
MODULE_DESCRIPTION("TCP BBRplus - 4.14 compatible");