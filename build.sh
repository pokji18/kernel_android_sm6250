...
CLANG_DIR="${CLANG_DIR:-$KERNEL_DIR/../clang/NezukoClang}"
GCC32_DIR="${GCC32_DIR:-$KERNEL_DIR/../clang/NezukoClang/arm-linux-androideabi-4.9}"
ARCH="arm64"
...
export PATH="$CLANG_DIR/bin:${GCC32_DIR:+$GCC32_DIR/bin:}$PATH"
